...
export class InMemoryDataService implements InMemoryDbService {
      ...
      { id: 'id2', title: 'TestPost2', body: 'Test body 2', date: new Date(), tags: ['testTag1', 'testTag3'] },
      {
        ...
        body: `
          <h2>Intro</h2>
            ...
            <p>I already wanted to start this blog, so I thought it would be the perfect guinea pig. That meant I had a couple
  ...
  <a href="https://medium.freecodecamp.org/building-a-node-js-application-on-android-part-1-termux-vim-and-node-js-dfa90c28958f">this</a>
            ...
            <p>
                ...
                down for [mostly] good reasons, and if I can work within those constraints, that’s what I want to do.
            </p>
            <p>
                The first problem I ran into was trying to run
                <code>yarn install</code> on a project created anywhere outside the
                <code>home</code> directory created by Termux. To grossly oversimplify,
                Android file permissions prevent a user from creating
            ...
            <h2>The “IDE”</h2>
            <p>Next on my list: an IDE. Several searches and reviews all pointed me to the same app; I won’t put it directly,
                but even a cursory Google search should make it fairly obvious. I had two problems with it:
                <ol>
                    <li>
                        I wasn’t able to navigate to the folder where I had just bootstrapped my app
                        (and now that I think about it, even if I had
                        been able to since it was a directory that belonged to Termux, I wouldn’t have been able to access
                        it anyway)
                    </li>
                    <li>
                        Its constant begging for money was a huge turnoff
                        (I already know how to code, I’m not going to pay so you can give me some
            ...
            <p>The answer: vim. I know someone who swears by it, and does all of their development work in it. I’m a nerd, and
            ...
            <p>
                ...
                good
                <code>.vmrc</code> set up, it felt as natural as Sublime or VSC. The only phone specific problems I’ve had were related to
       ...
       <a href="https://github.com/Microsoft/TypeScript/wiki/TypeScript-Editor-Support#vim">here</a>) to set vim up for TypeScript. My own
            ...
            <h2>Tests</h2>
            <p>
                So, I have my environment set up. I have a git repo (obviously…)
                to be able to switch from my laptop to my phone on occasion,
                but my the idea is to force myself do the majority of the development on my phone. The only times I’ve used
            ...
            <p>
                ...
                was where I hit a brick wall that took me a few days to find fix (It honestly probably took me far longer
            ...
            <p>
              ...
              <a href="https://blog.cloudboost.io/angular-jest-wallabyjs-why-it-is-the-ideal-combination-and-how-to-configure-b4cbe2eff4b3">
                    this</a> blog. It suggests and instructs how to set up Jest as the main testing framework, and it was
